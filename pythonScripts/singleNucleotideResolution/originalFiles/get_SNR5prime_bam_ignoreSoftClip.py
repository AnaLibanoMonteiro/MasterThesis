        ...
        for line in infile:
            if not line.startswith("@"):
                ...
                if line[1] in flags and line[6]=="=" and \
                    ...
                    if line[1]==flags[0]:
                        #first in pair (99), forward
                        #line[1]="99" # unnecessary
                        line=setStrand(line)
                        add_to_start=readLength_CIGAR(line[5])
                        line[3]=str(int(line[3])+add_to_start)
                        line[9]=line[9][0] # CHANGED from -1 to 0
                        line[10]=line[10][0] # CHANGED from -1 to 0
                        line[5]="1M"

                    elif line[1]==flags[1]:
                        #first in pair (83), reverse
                        #line[1]="83" # unnecessary
                        line=setStrand(line)
                        line[9]=line[9][-1] # CHANGED from 0 to -1
                        line[10]=line[10][-1] # CHANGED from 0 to -1
                        line[5]="1M"
